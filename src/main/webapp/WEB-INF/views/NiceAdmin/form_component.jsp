...
<html>
  ...
  <!-- container section end -->
    ...
    <!-- jquery ui -->
    <script src="/scts/resources/js/jquery-ui-1.9.2.custom.min.js"></script>

    <!--custom checkbox & radio-->
    <script type="text/javascript" src="/scts/resources/js/ga.js"></script>
    <!--custom switch-->
    <script src="/scts/resources/js/bootstrap-switch.js"></script>
    <!--custom tagsinput-->
    <script src="/scts/resources/js/jquery.tagsinput.js"></script>
    
    <!-- colorpicker -->
   
    <!-- bootstrap-wysiwyg -->
    <script src="/scts/resources/js/jquery.hotkeys.js"></script>
    <script src="/scts/resources/js/bootstrap-wysiwyg.js"></script>
    <script src="/scts/resources/js/bootstrap-wysiwyg-custom.js"></script>
    <!-- ck editor -->
    <script type="text/javascript" src="/scts/resources/assets/ckeditor/ckeditor.js"></script>
    <!-- custom form component script for this page-->
    <script src="/scts/resources/js/form-component.js"></script>
