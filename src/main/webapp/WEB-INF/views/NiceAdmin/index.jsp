...
<!-- full calendar css-->
<link
	href="/scts/resources/assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css"
	rel="stylesheet" />
<link
	href="/scts/resources/assets/fullcalendar/fullcalendar/fullcalendar.css"
	rel="stylesheet" />
<!-- easy pie chart-->
<link
	href="/scts/resources/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css"
	rel="stylesheet" type="text/css" media="screen" />
<!-- owl carousel -->
<link rel="stylesheet" href="/scts/resources/css/owl.carousel.css"
	type="text/css">
...
<link href="/scts/resources/css/xcharts.min.css" rel=" stylesheet">
<link href="/scts/resources/css/jquery-ui-1.10.4.min.css"
	rel="stylesheet">
<!-- =======================================================
...
<body>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<table class="table bootstrap-datatable countries">
									...
									<tbody>
										<tr>
											<td><img src="/scts/resources/img/Germany.png"
										...
										<tr>
											<td><img src="/scts/resources/img/India.png"
												style="height: 18px; margin-top: -2px;"></td>
											<td>India</td>
											<td>3652</td>
											<td>2563</td>
										...
										<tr>
											<td><img src="/scts/resources/img/Spain.png"
												style="height: 18px; margin-top: -2px;"></td>
											<td>Spain</td>
											<td>562</td>
											<td>452</td>
									...
									<ul class="chats">
										...
										<li class="by-me">
											...
											<div class="avatar pull-left">
												<img src="/scts/resources/img/user.jpg" alt="" />
											</div>
										...
										<li class="by-other">
											...
											<div class="avatar pull-right">
												<img src="/scts/resources/img/user22.png" alt="" />
											</div>
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<span class="profile-ava pull-right"> <img alt=""
											class="simple" src="/scts/resources/img/avatar1_small.jpg">
											Jenifer smith
										</span>
									</div>
								</div>
	...
	<script src="/scts/resources/js/jquery-ui-1.10.4.min.js"></script>
	<script type="text/javascript"
		src="/scts/resources/js/jquery-ui-1.9.2.custom.min.js"></script>
	<!-- bootstrap -->
	...
	<script src="/scts/resources/js/jquery.sparkline.js"
		type="text/javascript"></script>
	<script
		src="/scts/resources/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
	<script src="/scts/resources/js/owl.carousel.js"></script>
	<!-- jQuery full calendar -->
	<script src="/scts/resources/js/fullcalendar.min.js"></script>
	<!-- Full Google Calendar - Calendar -->
	<script
		src="/scts/resources/assets/fullcalendar/fullcalendar/fullcalendar.js"></script>
	<!--script for this page only-->
	<script src="/scts/resources/js/calendar-custom.js"></script>
	<script src="/scts/resources/js/jquery.rateit.min.js"></script>
	<!-- custom select -->
	<script src="/scts/resources/js/jquery.customSelect.min.js"></script>
	<script src="/scts/resources/assets/chart-master/Chart.js"></script>

	<!--custome script for all page-->
	<script src="/scts/resources/js/scripts.js"></script>
	<!-- custom script for this page-->
	<script src="/scts/resources/js/sparkline-chart.js"></script>
	<script src="/scts/resources/js/easy-pie-chart.js"></script>
	<script src="/scts/resources/js/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="/scts/resources/js/jquery-jvectormap-world-mill-en.js"></script>
	<script src="/scts/resources/js/xcharts.min.js"></script>
	<script src="/scts/resources/js/jquery.autosize.min.js"></script>
	<script src="/scts/resources/js/jquery.placeholder.min.js"></script>
	<script src="/scts/resources/js/gdp-data.js"></script>
	<script src="/scts/resources/js/morris.min.js"></script>
	<script src="/scts/resources/js/sparklines.js"></script>
	<script src="/scts/resources/js/charts.js"></script>
	<script src="/scts/resources/js/jquery.slimscroll.min.js"></script>
	<script>
		//knob
		$(function() {
			$(".knob").knob({
