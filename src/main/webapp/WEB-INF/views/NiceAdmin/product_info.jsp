      ...
      <!--sidebar end-->
		...
		<section id="main-content">
			<section class="wrapper">
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header"><i class="fa fa fa-bars"></i>물품 정보 등록</h3>
						<ol class="breadcrumb">
								...
								<div class="form">
									<form class="form-validate form-horizontal" id="feedback_form"
										...
										<div class="form-group ">
											<label for="name" class="control-label col-lg-2">물품 사진
												<span class="required">*</span>
											</label>
											<div class="col-lg-2">
												<img src="resources/img/bg-1" style="width:200px; height :200px;">
											</div>
											
											<div class="form-group ">
												<label for="name" class="control-label col-lg-2">물품 명
													<span class="required">*</span>
												</label>
												<div class="col-lg-3">
												...
												<br>
												<br>
													<label for="amount" class="control-label col-lg-2">카테고리 정보
														<span class="required">*</span>
													</label>
													<div class="col-lg-3">
												...
												<br>
												<br>
													<label for="price" class="control-label col-lg-2">판매 가
														<span class="required">*</span>
													</label>
													<div class="col-lg-3">
												...
												<br>
												<br>
													<label for="price" class="control-label col-lg-2">판매 수량
														<span class="required">*</span>
													</label>
													<div class="col-lg-3">
														<input class="form-control" id="price" name="fullname"
										...
										<div class="form-group ">
											<label for="ccomment" class="control-label col-lg-2">물품 부가 정보</label>
											<div class="col-lg-8">
