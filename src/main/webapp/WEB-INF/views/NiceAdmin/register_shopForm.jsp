      ...
      <!--sidebar end-->
		...
		<section id="main-content">
			<section class="wrapper">
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header"><i class="fa fa fa-bars"></i> 설계도면 등록</h3>
						<ol class="breadcrumb">
							...
							<div class="panel-body">
								<div class="form">
									<form class="form-validate form-horizontal" id="feedback_form"
										...
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">첨부파일
											<span class="required">*</span>
											</label>
											<div class="col-lg-10">
										...
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">층정보
											<span class="required">*</span>
											</label>
											<div class="col-lg-10">
										...
										<div class="form-group ">
											<label for="ccomment" class="control-label col-lg-2">설계도면 부가 정보</label>
											<div class="col-lg-10">
